    ...
    var items = [
      {
        ...
        descripcion: 'Pantalla base creada para administradores.',
        estado: 'ok'
      },
      {
        titulo: 'CSS propio',
        descripcion: 'El módulo usa estilos propios y no depende de estudiantes ni coordinadores.',
        estado: 'ok'
      },
      {
        titulo: 'JS propio',
      ...
      {
        titulo: 'Firebase',
        descripcion: 'Pendiente para administrar períodos, estudiantes, coordinadores e IA.',
        estado: 'pending'
      },
      {
        titulo: 'Electron',
        descripcion: 'Pendiente para el instalador propio de administradores.',
        estado: 'pending'
      },
      {
        titulo: 'Panel administrativo',
        descripcion: 'Pendiente de implementar el flujo completo de gestión.',
        estado: 'pending'
      }
    ];
